...
func InitOptionMap() {
	...
	common.OptionMap["ModelMultiplier"] = ratio_setting.ModelMultiplier2JSONString()
...
func applyEnvironmentOptionOverrides() {
	...
	if githubClientSecret != "" {
		common.GitHubClientSecret = githubClientSecret
	}
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "ModelMultiplier":
		err = ratio_setting.UpdateModelMultiplierByJSONString(value)
	case "GroupRatio":
