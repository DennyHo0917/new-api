...
func TokenAuth() func(c *gin.Context) {
	return func(c *gin.Context) {
		...
		tokenGroup := effectiveTokenGroup(token.Group)
		if tokenGroup != "auto" {
...
func effectiveTokenGroup(group string) string {
	if group == "" {
		return "auto"
	}
	return group
...
func SetupContextForToken(c *gin.Context, token *model.Token, parts ...string) error {
	...
	common.SetContextKey(c, constant.ContextKeyTokenGroup, effectiveTokenGroup(token.Group))
