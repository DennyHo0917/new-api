...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/model_multipliers", permission: authz.ChannelRead, handler: controller.GetChannelModelMultipliers},
	{method: http.MethodPut, path: "/model_multiplier", permission: authz.ChannelWrite, handler: controller.UpdateChannelModelMultiplier},
